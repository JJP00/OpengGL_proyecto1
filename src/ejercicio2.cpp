...
//     glShaderSource(fragmentShader, 1, &fragmentShaderSourceNaranja, NULL);
...
//     glAttachShader(shaderProgram2, fragmentShaderAmarillo);
...
//     unsigned int VBO[2]; // vertex buffer objects, almacena los datos del vertice en la GPU...
//     unsigned int VAO[2]; // vertex array  objects, almacena el VBO y los atributos, explica lo que significa cada parte del vertice, posición, normal, coord de las texturas...
//     // unsigned int EBO; // Element buffer objects, indica el orden de dibujado de cada vertice

//     // glGenBuffers(1, &EBO);
//     glGenBuffers(2, VBO); // genera uno o mas ids para cada VBO
//     glGenVertexArrays(2, VAO);

//     glBindVertexArray(VAO[0]);

//     glBindBuffer(GL_ARRAY_BUFFER, VBO[0]);                                     // asociar y definir que VBO es de tipo GL_ARRAY_BUFFER
